          ...
          <div class="row main-wrapper rounded">
            ...
            <div class="columns main-wrapper rounded shadow">
              <div class="page heading">
                <h2 style="display: block;" align="center">Control Video</h2>
                <hr width="75%"/>
             <div class="small-12 large-12 columns">
                                          <div class="small-12 large-9 columns">
                                            <h5>Pilih video simulasi:</h5>
                                              <ul class="disc">
                                                <li><a href="vide_seluruh.php">Materi Keseluruhan</li>
                                                <li><a href="../SRL/web/bubble.html">Bubble Sort (Metode Gelembung)</a></li>
                                                <li><a href="../S/web/selection.html">Selection Sort (Metode Seleksi)</a></li>
                                                <li><a href="../SRL/web/insertion.html">Insertion Sort (Metode Sisipan)</a></li>
                                                <li>Shell Sort (Metode Shell)</li>
                                                <li><a href="../SRL/web/merge.html">Merge Sort (Metode Merge)</a></li>
                                              </ul>
                                              <br>
                                              <br>
                                              <br>
                                          ...
                                          <a href="6-Sorting1-Learning-Evaluation.php" class="button success expanded">Klik disini untuk mengakhiri belajar dan siap melaksanakan evaluasi</a>
                                    </div>
