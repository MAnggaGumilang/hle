...
GROUP BY tb_fuz_skor_mhs_mai.id_mhs ");
         ...
         mysqli_query($connect, "insert into tb_fuz_derajat_mai values('".$id_mhs."',  '".$dataknowledge[0]."', '".$dataknowledge[1]."', '".$dataknowledge[2]."', '".$dataregulation[0]."', '".$dataregulation[1]."', '".$dataregulation[2]."', now())"); 
