          ...
          <div class="row main-wrapper rounded">
            ...
            <div class="columns main-wrapper rounded shadow">
              <div class="page heading">
                <h2 style="display: block;" align="center">Control Video</h2><br><h5>Klik "Back" pada browser untuk kembali ke menu pilihan video</h5>
                <hr width="75%"/>
             <div class="small-12 large-12 columns">
                                          <div class="small-12 large-9 columns">
                                            <object type="../assets/videos/ASD_Sesi10.mp4"
