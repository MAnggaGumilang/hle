...
?>
  <!--<a href="../SRL/5-Sorting2-lowK-Learning-Materials-Control-Video.php" class="button success expanded">Ya</a>-->
<?php
}
elseif ($rekom==$knowledge && $knowledge_kategori==2) {
  ?>
  <a href="../SRL/5-Sorting2-medK-Learning-Materials-Control-Video.php" class="button success expanded">Ya</a>
<?php
}
elseif ($rekom==$knowledge && $knowledge_kategori==3) {
  ?>
  <a href="../SRL/5-Sorting2-highK-Learning-Materials-Control-Video.php" class="button success expanded">Ya</a>
<?php
}
elseif ($rekom==$regulation && $regulation_kategori==1) {
  ?>
  <a href="../SRL/5-Sorting2-lowR-Learning-Materials-Control-Video.php" class="button success expanded">Ya</a>
<?php
}
elseif ($rekom==$regulation && $regulation_kategori==2) {
  ?>
  <a href="../SRL/5-Sorting2-medR-Learning-Materials-Control-Video.php" class="button success expanded">Ya</a>
<?php
}
elseif ($rekom==$regulation && $regulation_kategori==3) {
  ?>
  <a href="../SRL/5-Sorting2-highR-Learning-Materials-Control-Video.php" class="button success expanded">Ya</a>
<?php
}
...
if ($rekom==$knowledge && $knowledge_kategori==1) {
?>
  <!--<a href="../SRL/5-Sorting2-lowK-Learning-Material-Draw.php" class="button success expanded">Ya</a>-->
<?php
}
elseif ($rekom==$knowledge && $knowledge_kategori==2) {
  ?>
  <a href="../SRL/5-Sorting2-medK-Learning-Material-Draw.php" class="button success expanded">Ya</a>
<?php
}
elseif ($rekom==$knowledge && $knowledge_kategori==3) {
  ?>
  <a href="../SRL/5-Sorting2-highK-Learning-Material-Draw.php" class="button success expanded">Ya</a>
<?php
}
elseif ($rekom==$regulation && $regulation_kategori==1) {
  ?>
  <a href="../SRL/5-Sorting2-lowR-Learning-Material-Draw.php" class="button success expanded">Ya</a>
<?php
}
elseif ($rekom==$regulation && $regulation_kategori==2) {
  ?>
  <a href="../SRL/5-Sorting2-medR-Learning-Material-Draw.php" class="button success expanded">Ya</a>
<?php
}
elseif ($rekom==$regulation && $regulation_kategori==3) {
  ?>
  <a href="../SRL/5-Sorting2-highR-Learning-Material-Draw.php" class="button success expanded">Ya</a>
<?php
}
...
if ($rekom==$knowledge && $knowledge_kategori==1) {
?>
  <!--<a href="../SRL/5-Sorting2-lowK-Learning-Materials-Summary.php" class="button success expanded">Ya</a>-->
<?php
}
elseif ($rekom==$knowledge && $knowledge_kategori==2) {
  ?>
  <a href="../SRL/5-Sorting2-medK-Learning-Materials-Summary.php" class="button success expanded">Ya</a>
<?php
}
elseif ($rekom==$knowledge && $knowledge_kategori==3) {
  ?>
  <a href="../SRL/5-Sorting2-highK-Learning-Materials-Summary.php" class="button success expanded">Ya</a>
<?php
}
elseif ($rekom==$regulation && $regulation_kategori==1) {
  ?>
  <a href="../SRL/5-Sorting2-lowR-Learning-Materials-Summary.php" class="button success expanded">Ya</a>
<?php
}
elseif ($rekom==$regulation && $regulation_kategori==2) {
  ?>
  <a href="../SRL/5-Sorting2-medR-Learning-Materials-Summary.php" class="button success expanded">Ya</a>
<?php
}
elseif ($rekom==$regulation && $regulation_kategori==3) {
  ?>
  <a href="../SRL/5-Sorting2-highR-Learning-Materials-Summary.php" class="button success expanded">Ya</a>
<?php
}
